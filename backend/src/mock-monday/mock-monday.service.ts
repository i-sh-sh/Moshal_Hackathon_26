...
export class MockMondayService {
    ...
    /** Simulates teacher clicking "Approved" on a Monday item */
    ...
    /** Simulates teacher rejecting — sends back to PM review */
    ...
    /** Simulates teacher kicking off a challenge from Monday */
